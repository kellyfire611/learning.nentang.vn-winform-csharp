...
{
    public partial class FrmGopY_2 : Form
    {
        ...
        private void FrmGopY_2_Load(object sender, EventArgs e)
        {
        ...
        private void btnGoiGopY_Click(object sender, EventArgs e)
        {
            ...
            if(String.IsNullOrEmpty(chudeGopY)) // Rule 1: Required (bắt buộc nhập)
            {
                ...
                errorProvider1.SetError(cbbGopY, loi);
            }
            else
            {
                errorProvider1.SetError(cbbGopY, "");
            }
            ...
            if (String.IsNullOrEmpty(hoten)) // Rule 1: Required (bắt buộc nhập)
            {
                ...
                errorProvider1.SetError(txtHoTen, loi);
            }
            ...
            if (String.IsNullOrEmpty(sdt)) // Rule 1: Required (bắt buộc nhập)
            {
            ...
            {
                errorProvider1.SetError(txtNoiDung, "");
            }
